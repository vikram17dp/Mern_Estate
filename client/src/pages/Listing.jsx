...
export default function Listing() {
  ...
  return (
    <main>
      {loading && (
        <p className="text-center my-7 text-3xl font-semibold">Loading...</p>
      )}

      {error && (
        <p className="text-3xl text-center my-7 font-semibold">
        ...
        <div>
          <Swiper navigation>
            {listing.imageUrls.map((url) => (
              <SwiperSlide key={url}>
                <div
                  className="h-[250px] sm:h-[550px] md:h-[550px] bg-cover bg-center"
                  style={{
